...
export const FLOW: Step[] = [
    ...
    { 
        type: 'bot', 
        message: '👋🏛️, *Sean bienvenidas a esta consulta organizada por UNEFCO* 📊. \n¡Su participación es clave para mejorar el rendimiento y la calidad educativa! 🌟📚 Su aporte será fundamental para orientar la gestión 2026 📅✨', 
        delay: 1000 
    },
